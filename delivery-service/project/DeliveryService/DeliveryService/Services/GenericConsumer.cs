...
namespace DeliveryService.Services
{
    public class GenericConsumer<T> : BackgroundService where T : class, new()
    {
        ...
        private readonly DeliveryContextService _dbService;
        private readonly Func<T, DeliveryContextService, Task<Boolean>> _postConsumeHandler;

        public GenericConsumer(ConsumerConfig consumerConfig,
                                        ILogger<GenericConsumer<T>> logger,
                                        DeliveryContextService dbService, 
                                        Func<T, DeliveryContextService, Task<Boolean>> postConsumeHandler)
        {
